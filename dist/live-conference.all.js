...
angular.module('op.liveconference-templates', []).run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put("templates/name-editor-dialog.jade",
    "<div tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\" class=\"modal report-modal fade\"><div class=\"modal-dialog modal-lg\"><div class=\"modal-content left modal-hublin\"><div class=\"modal-header\"><button type=\"button\" data-dismiss=\"modal\" aria-label=\"Close\" class=\"close\"><span aria-hidden=\"true\">&times;</span></button><h4 class=\"modal-title\">Change display name</h4></div><div class=\"modal-body\"><div class=\"row\"><div class=\"container-fluid\"><div class=\"row\"><form name=\"changeDisplayName\" class=\"form-horizontal\"><div class=\"form-group\"><label class=\"col-sm-2 control-label\">New name</label><div class=\"col-sm-9\"><input type=\"text\" placeholder=\"Display Name\" ng-model=\"newDisplayName\" required class=\"form-control form-control\"></div></div></form></div></div></div></div><div class=\"modal-footer\"><button data-dismiss=\"modal\" class=\"btn btn-default\">Cancel</button><button ng-click=\"updateDisplayName()\" class=\"btn btn-primary\">Update</button></div></div></div></div>");
